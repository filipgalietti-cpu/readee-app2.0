...
export const SHOP_ITEMS: ShopItem[] = [
  ...
  // Watercolor scenes (soft painterly look, batch 2)
  { id: "bg_wildflower_field",  name: "Wildflower Field", icon: "flower-2",        category: "backgrounds", price: 75,  description: "A soft meadow of wildflowers" },
  { id: "bg_moonlit_lake",      name: "Moonlit Lake",     icon: "moon",            category: "backgrounds", price: 125, description: "A calm lake under the moon" },
  { id: "bg_misty_forest",      name: "Misty Forest",     icon: "trees",           category: "backgrounds", price: 100, description: "A peaceful misty forest" },
  { id: "bg_lavender_hills",    name: "Lavender Hills",   icon: "flower",          category: "backgrounds", price: 125, description: "Rolling lavender hills" },
  { id: "bg_autumn_woods",      name: "Autumn Woods",     icon: "tree-deciduous",  category: "backgrounds", price: 100, description: "A cozy autumn woodland" },
  { id: "bg_snowy_pines",       name: "Snowy Pines",      icon: "snowflake",       category: "backgrounds", price: 100, description: "A quiet snowy pine forest" },
  { id: "bg_koi_pond",          name: "Koi Pond",         icon: "fish",            category: "backgrounds", price: 150, description: "A tranquil koi pond" },
  { id: "bg_bamboo_grove",      name: "Bamboo Grove",     icon: "trees",           category: "backgrounds", price: 100, description: "A serene bamboo grove" },
  { id: "bg_tulip_garden",      name: "Tulip Garden",     icon: "flower-2",        category: "backgrounds", price: 75,  description: "A field of bright tulips" },
  { id: "bg_foggy_harbor",      name: "Foggy Harbor",     icon: "waves",           category: "backgrounds", price: 125, description: "A calm harbor at dawn" },
  { id: "bg_sunflower_field",   name: "Sunflower Field",  icon: "sun",             category: "backgrounds", price: 75,  description: "A sunny field of sunflowers" },
  { id: "bg_cloud_kingdom",     name: "Cloud Kingdom",    icon: "cloud",           category: "backgrounds", price: 150, description: "A dreamy kingdom of clouds" },
  { id: "bg_rolling_hills",     name: "Rolling Hills",    icon: "mountain",        category: "backgrounds", price: 50,  description: "Gentle green rolling hills" },
  { id: "bg_willow_creek",      name: "Willow Creek",     icon: "waves",           category: "backgrounds", price: 100, description: "A creek beneath a willow" },
  { id: "bg_peach_sunrise",     name: "Peach Sunrise",    icon: "sunrise",         category: "backgrounds", price: 125, description: "A soft peach sunrise" },
  { id: "bg_pine_valley",       name: "Pine Valley",      icon: "trees",           category: "backgrounds", price: 100, description: "A calm pine valley lake" },
  { id: "bg_mushroom_hollow",   name: "Mushroom Hollow",  icon: "sparkles",        category: "backgrounds", price: 150, description: "A glowing mushroom hollow" },
  { id: "bg_seagrass_bay",      name: "Seagrass Bay",     icon: "shell",           category: "backgrounds", price: 100, description: "A gentle seagrass bay" },
  { id: "bg_maple_hill",        name: "Maple Hill",       icon: "tree-deciduous",  category: "backgrounds", price: 100, description: "A maple tree on a hill" },
  { id: "bg_starlit_desert",    name: "Starlit Desert",   icon: "sparkles",        category: "backgrounds", price: 150, description: "A starlit desert night" },
  { id: "bg_northern_woods",    name: "Northern Woods",   icon: "trees",           category: "backgrounds", price: 175, description: "Evergreens under twilight" },
  { id: "bg_quiet_cove",        name: "Quiet Cove",       icon: "waves",           category: "backgrounds", price: 100, description: "A secluded seaside cove" },
...
export const BACKGROUND_IMAGES: Record<string, string> = {
  ...
  bg_wildflower_field: "/images/backgrounds/bg_wildflower_field.png",
  bg_moonlit_lake:     "/images/backgrounds/bg_moonlit_lake.png",
  bg_misty_forest:     "/images/backgrounds/bg_misty_forest.png",
  bg_lavender_hills:   "/images/backgrounds/bg_lavender_hills.png",
  bg_autumn_woods:     "/images/backgrounds/bg_autumn_woods.png",
  bg_snowy_pines:      "/images/backgrounds/bg_snowy_pines.png",
  bg_koi_pond:         "/images/backgrounds/bg_koi_pond.png",
  bg_bamboo_grove:     "/images/backgrounds/bg_bamboo_grove.png",
  bg_tulip_garden:     "/images/backgrounds/bg_tulip_garden.png",
  bg_foggy_harbor:     "/images/backgrounds/bg_foggy_harbor.png",
  bg_sunflower_field:  "/images/backgrounds/bg_sunflower_field.png",
  bg_cloud_kingdom:    "/images/backgrounds/bg_cloud_kingdom.png",
  bg_rolling_hills:    "/images/backgrounds/bg_rolling_hills.png",
  bg_willow_creek:     "/images/backgrounds/bg_willow_creek.png",
  bg_peach_sunrise:    "/images/backgrounds/bg_peach_sunrise.png",
  bg_pine_valley:      "/images/backgrounds/bg_pine_valley.png",
  bg_mushroom_hollow:  "/images/backgrounds/bg_mushroom_hollow.png",
  bg_seagrass_bay:     "/images/backgrounds/bg_seagrass_bay.png",
  bg_maple_hill:       "/images/backgrounds/bg_maple_hill.png",
  bg_starlit_desert:   "/images/backgrounds/bg_starlit_desert.png",
  bg_northern_woods:   "/images/backgrounds/bg_northern_woods.png",
  bg_quiet_cove:       "/images/backgrounds/bg_quiet_cove.png",
  bg_poppy_meadow:     "/images/backgrounds/bg_poppy_meadow.png",
  bg_frosted_valley:   "/images/backgrounds/bg_frosted_valley.png",
  bg_dandelion_dusk:   "/images/backgrounds/bg_dandelion_dusk.png",
};
