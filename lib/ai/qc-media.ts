...
INTERIOR-ANATOMY BAN: for human-body topics (bones, muscles, blood, organs, digestion), FAIL any interior or cross-section view of the body — fleshy tissue, organs, floating bones inside red/pink flesh, veins, cutaways. These read as visceral and unsettling to young children even in soft watercolor. Body-topic images must show the EXTERIOR, kid-relatable side of the topic: a clothed child jumping, stretching, measuring their height, drinking milk, playing. A simple clean white-on-dark skeleton silhouette (X-ray poster style, no flesh) is the only acceptable interior-adjacent form.
