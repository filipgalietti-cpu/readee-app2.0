...
const MILESTONE_STYLE: Record<number, { icon: FluentIconName; accent: ReaderLevel["accent"] }> = {
  ...
  30: { icon: "ship", accent: { bg: "bg-orange-500", fg: "text-white", soft: "bg-orange-50 text-orange-800", gradFrom: "from-orange-400", hexDeep: "#ea580c", hex: "#f97316", gradTo: "to-orange-500" } },
  ...
  50: { icon: "graduation-cap", accent: { bg: "bg-amber-500", fg: "text-white", soft: "bg-amber-50 text-amber-800", gradFrom: "from-amber-400", hexDeep: "#d97706", hex: "#f59e0b", gradTo: "to-amber-500" } },
  ...
  70: { icon: "feather", accent: { bg: "bg-lime-500", fg: "text-white", soft: "bg-lime-50 text-lime-800", gradFrom: "from-lime-400", hexDeep: "#65a30d", hex: "#84cc16", gradTo: "to-lime-500" } },
  ...
  90: { icon: "fire", accent: { bg: "bg-red-500", fg: "text-white", soft: "bg-red-50 text-red-800", gradFrom: "from-red-400", hexDeep: "#dc2626", hex: "#ef4444", gradTo: "to-red-500" } },
  100: { icon: "glowing-star", accent: { bg: "bg-sky-500", fg: "text-white", soft: "bg-sky-50 text-sky-800", gradFrom: "from-sky-400", hexDeep: "#0284c7", hex: "#0ea5e9", gradTo: "to-sky-500" } },
  ...
  200: { icon: "gem", accent: { bg: "bg-emerald-500", fg: "text-white", soft: "bg-emerald-50 text-emerald-800", gradFrom: "from-emerald-400", hexDeep: "#059669", hex: "#10b981", gradTo: "to-emerald-500" } },
  250: { icon: "telescope", accent: { bg: "bg-purple-500", fg: "text-white", soft: "bg-purple-50 text-purple-800", gradFrom: "from-purple-400", hexDeep: "#9333ea", hex: "#a855f7", gradTo: "to-purple-500" } },
  ...
  400: { icon: "memo", accent: { bg: "bg-rose-500", fg: "text-white", soft: "bg-rose-50 text-rose-800", gradFrom: "from-rose-400", hexDeep: "#e11d48", hex: "#f43f5e", gradTo: "to-rose-500" } },
  500: { icon: "ringed-planet", accent: { bg: "bg-cyan-500", fg: "text-white", soft: "bg-cyan-50 text-cyan-800", gradFrom: "from-cyan-400", hexDeep: "#0891b2", hex: "#06b6d4", gradTo: "to-cyan-500" } },
  600: { icon: "mountain", accent: { bg: "bg-amber-500", fg: "text-white", soft: "bg-amber-50 text-amber-800", gradFrom: "from-amber-400", hexDeep: "#d97706", hex: "#f59e0b", gradTo: "to-amber-500" } },
  700: { icon: "sun-face", accent: { bg: "bg-indigo-500", fg: "text-white", soft: "bg-indigo-50 text-indigo-800", gradFrom: "from-indigo-400", hexDeep: "#4f46e5", hex: "#6366f1", gradTo: "to-indigo-500" } },
  800: { icon: "satellite", accent: { bg: "bg-teal-500", fg: "text-white", soft: "bg-teal-50 text-teal-800", gradFrom: "from-teal-400", hexDeep: "#0d9488", hex: "#14b8a6", gradTo: "to-teal-500" } },
  900: { icon: "sunrise", accent: { bg: "bg-orange-500", fg: "text-white", soft: "bg-orange-50 text-orange-800", gradFrom: "from-orange-400", hexDeep: "#ea580c", hex: "#f97316", gradTo: "to-orange-500" } },
