...
const AUDIO_FILES = [
  "lessons/RF.K.3b/S4a.mp3",
  "lessons/RF.K.3b/S4b.mp3",
  "lessons/RF.K.3b/S4c.mp3",
];

const IMAGE_FILES = [
  "lessons/RF.K.3b/S2a.png",
  "lessons/RF.K.3b/S2b.png",
  "lessons/RF.K.3b/S2c.png",
  "lessons/RF.K.3b/S3c.png",
  "lessons/RF.K.3b/S4.png",
];
...
(async () => {
  ...
  for (const f of IMAGE_FILES) {
    if (await uploadFile("images", f, IMAGES_DIR, "image/png")) ok++; else fail++;
  }
