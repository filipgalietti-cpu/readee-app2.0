...
export default function Home() {
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      {/* Start a Lesson CTA */}
      <Card variant="bordered" accentColor={accentColor} className="p-8 text-center">
        <div className="text-5xl mb-4">🎯</div>
        <h2 className="text-2xl font-bold text-zinc-900 mb-2">Ready to learn?</h2>
        <p className="text-zinc-600 mb-6">Start a new lesson and earn rewards!</p>
        <Link href="/library">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <Link href="/library">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer text-center">
            ...
            <h3 className="font-semibold text-zinc-900">Library</h3>
            <p className="text-sm text-zinc-600">Browse stories</p>
          </Card>
        </Link>
        <Link href="/dashboard">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer text-center">
            ...
            <p className="text-sm text-zinc-600">Track progress</p>
          </Card>
        </Link>
        <Link href="/about">
          <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer text-center">
            ...
            <p className="text-sm text-zinc-600">Learn more</p>
          </Card>
        </Link>
      </div>
    </div>
