...
export function SidebarUserMenu({
  ...
  function InitialsAvatar({ size }: { size: "sm" | "md" }) {
    ...
    return (
      <div
        className={`${cls} rounded-lg flex-shrink-0 flex items-center justify-center bg-gradient-to-br from-violet-600 to-violet-500 font-bold text-white ring-1 ring-indigo-200`}
      >
        {initials || "U"}
      </div>
    );
