 ...
 */
const IMMERSIVE_PREFIXES = ["/learn/unit-one", "/journey", "/placement", "/demo/journey-v2", "/demo/journey-progress", "/demo/placement-run", "/demo/placement-reveal", "/demo/placement-studio"];
