...
export default function LearningPathCard({
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-violet-200 bg-gradient-to-br from-violet-50 via-white to-indigo-50">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="text-sm font-bold text-zinc-900">
              ...
              {path.reading_level ? (
                <span className="ml-2 rounded-full bg-zinc-100 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-zinc-600">
                  {path.reading_level}
                </span>
              ) : null}
            </div>
      ...
      {/* Progress bar */}
      <div className="mx-5 mt-3 h-2 overflow-hidden rounded-full bg-white/80">
        <div
      ...
      {variant !== "kid" && upcoming.length > 1 && (
        <details className="mx-5 mt-3 mb-5 rounded-2xl bg-white/60 p-3 text-xs">
          <summary className="cursor-pointer font-bold text-zinc-600">
      ...
      <div className="mx-5 mb-5 mt-3 text-[10px] text-zinc-400">
