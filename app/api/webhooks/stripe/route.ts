...
<html><body style="margin:0;padding:0;background:#f6f5f2;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#18181b;">
  <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="padding:32px 16px;background:#f6f5f2;"><tr><td align="center">
    <table width="560" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;width:100%;">
      ...
      <tr><td align="center" style="padding-top:22px;"><p style="margin:0;font-size:12px;line-height:1.7;color:#a1a1aa;">Questions? <a href="mailto:hello@readee.app" style="color:#4f46e5;text-decoration:none;">hello@readee.app</a><br/><a href="https://instagram.com/readee.app"><img src="https://learn.readee.app/images/ui/social/instagram.png" alt="Instagram" width="26" height="26" style="display:inline-block;vertical-align:middle;border:0;outline:none;text-decoration:none;" /></a>&nbsp;&nbsp;<a href="https://x.com/readee.app"><img src="https://learn.readee.app/images/ui/social/x.png" alt="X" width="26" height="26" style="display:inline-block;vertical-align:middle;border:0;outline:none;text-decoration:none;" /></a>&nbsp;&nbsp;<a href="https://facebook.com/readee.app"><img src="https://learn.readee.app/images/ui/social/facebook.png" alt="Facebook" width="26" height="26" style="display:inline-block;vertical-align:middle;border:0;outline:none;text-decoration:none;" /></a>&nbsp;&nbsp;<a href="https://tiktok.com/@readee.app"><img src="https://learn.readee.app/images/ui/social/tiktok.png" alt="TikTok" width="26" height="26" style="display:inline-block;vertical-align:middle;border:0;outline:none;text-decoration:none;" /></a><br/>Readee Learning LLC &middot; Built by educators</p></td></tr>
    </table>
  </td></tr></table>
</body></html>`;
  try {
