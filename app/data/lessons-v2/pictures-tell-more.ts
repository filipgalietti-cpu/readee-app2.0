...
export const picturesTellMoreImages: Record<string, string | { subject: string; ref?: string }> = {
  ...
  "page-4": { subject: "The same young boy with curly black hair in a striped orange t-shirt grinning happily on the back porch at night watching TWO raccoons side by side eating blueberries from a wide dish on the porch floor: the same big chubby raccoon with a black mask and striped tail, and next to it a much smaller tiny fluffy BABY raccoon, half the size, with the same black mask, holding one blueberry in its little paws, both raccoons clearly visible in the foreground, fireflies glowing in the dark yard, big full moon above", ref: "page-3" },
