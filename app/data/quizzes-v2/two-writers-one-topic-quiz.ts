...
export const twoWritersOneTopicQuiz: QuizDef = {
  ...
  questions: [
    ...
    },
    {
      ...
      hint: { audio: `${Q}/e-4-points-same-or-different-hint.mp3`, script: "Made for the river and helps the river are not the same idea, and neither writer said anything false." },
    ...
    },
    {
      ...
      interaction: { type: "choose", options: [{ id: "a-hippo-helps-the-river", label: "a hippo helps the river" }, { id: "a-hippo-walks-far-at-night", label: "a hippo walks far at night" }, { id: "a-hippo-is-made-for-the-river", label: "a hippo is made for rivers" }, { id: "a-hippo-eats-fish-and-frogs", label: "a hippo eats fish and frogs" }], correctId: "a-hippo-helps-the-river", coachWrong: "That one is a single detail, the other writer's point, or not what the text says. Ask what the fish, the frogs, and the birds all have in common." },
    },
    {
      ...
      hint: { audio: `${Q}/c-3-sort-only-or-both-hint.mp3`, script: "For each detail, ask whether writer one said it, and then whether writer two said it. Two yeses means In Both." },
