...
export const WORD_STEPS: { grade: PlacedBand; label: string; standard: string; words: string[] }[] = [
  ...
  { grade: 1, label: "Long vowels, endings and common words", standard: "RF.1.3", words: ["cake", "feet", "ride", "rain", "said", "jumping"] },
  { grade: 2, label: "Vowel patterns", standard: "RF.2.3", words: ["farm", "corn", "coin", "bird", "town", "cloud"] },
  { grade: 2, label: "Two-syllable and common words", standard: "RF.2.3", words: ["rabbit", "planted", "tiger", "because", "picnic", "sunset"] },
...
/** Reuse the authored sound contrasts rather than a constant distractor trio.
 * Positions are balanced separately; these remain receptive recognition items. */
export const LETTER_SOUND_CHOICES: Record<string, readonly string[]> = {
  m: ["m", "s", "t", "b"],
  s: ["t", "s", "z", "p"],
  t: ["d", "f", "t", "m"],
  p: ["b", "s", "n", "p"],
