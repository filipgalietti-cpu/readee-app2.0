...
export default function ReferralShareCard({
  ...
  return (
    <div className="rounded-3xl border-2 border-violet-200 bg-gradient-to-br from-violet-50 via-white to-indigo-50 p-6 shadow-sm">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-violet-200 pt-4">
        <span className="text-[11px] font-semibold text-zinc-500">
          Share via
        </span>
        <a
          href={emailHref}
          className="inline-flex items-center gap-1.5 rounded-full border border-violet-300 bg-white px-3 py-1 text-xs font-semibold text-violet-700 transition hover:bg-violet-50"
        >
