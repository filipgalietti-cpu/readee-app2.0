...
import { BarChart3, Sparkles, BookText, ClipboardCheck, Compass, Star, LifeBuoy, FileText, BookOpen } from "lucide-react";
...
const TILES: Tile[] = [
  ...
  { href: "/learning-report", icon: FileText, label: "Reading Report", desc: "Your child's reading progress at a glance.", tint: "from-sky-500 to-cyan-500" },
  { href: "/stories", icon: BookOpen, label: "Read to me", desc: "Decodable stories read aloud, sentence by sentence.", tint: "from-rose-500 to-pink-500" },
