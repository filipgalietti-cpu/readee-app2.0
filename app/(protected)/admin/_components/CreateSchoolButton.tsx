...
import { School, Plus, X, Loader2 } from "lucide-react";
import { createSchool } from "../actions";

export default function CreateSchoolButton({ districtId }: { districtId?: string | null }) {
  ...
  function submit() {
    ...
    start(async () => {
      ...
      setOpen(false);
      router.push(`/admin/school/${res.schoolId}`);
      router.refresh();
    });
  }
