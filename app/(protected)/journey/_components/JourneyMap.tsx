                ...
                <div key={l.id} style={{ position: "absolute", left: l.x, top: l.y, transform: "translate(-50%,-50%)", zIndex: z }}>
                  <div style={{ position: "relative", width: size, height: size }}>
                    {cur && <>
                      ...
                      <div style={{ position: "absolute", left: "50%", bottom: "calc(100% + 14px)", animation: startAnim, background: "#fff", color: "#059669", fontFamily: "var(--font-baloo), sans-serif", fontWeight: 700, fontSize: 15, letterSpacing: ".06em", padding: "6px 16px", borderRadius: 999, boxShadow: "0 6px 16px -4px rgba(30,27,75,.35),inset 0 0 0 2px #d1fae5", whiteSpace: "nowrap", transform: "translate(-50%,0)" }}>START</div>
                    </>}
